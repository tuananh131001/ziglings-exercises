...
fn printSecondLine() void {
    var second_line1: *const [22]u8 = undefined;
    second_line1 = "And with strange aeons";

    var second_line2: *const [19]u8 =  undefined;
    second_line2 = "even death may die.";
    std.debug.print("{s} {s}", .{ second_line1, second_line2 });
}
